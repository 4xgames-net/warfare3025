...
- ### Simplified Notation
  ...
  This shorthand maps d20 results directly to outcome categories:
	...
	- 15+ → "Good"
	- 19+ → "Excellent"
- This format makes it easier to reference skill ratings and expected outcomes at a glance. It also saves a lot of space. Calling it "P/A/G/E - notation might help memorizing the result tiers.
