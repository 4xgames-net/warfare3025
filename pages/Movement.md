...
- ### Terrain
	- terrain does not automatically slow units down, but may prove hazardous depending on the terrain and the movement type of the unit. Every time the unit enters a hex with differing terrain, it might need to accomplish a piloting check with a difficulty detailed in the table below. the consequences are also listed there.
